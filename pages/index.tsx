            ...
            <div className={styles.HeaderContentLeft}>
              ...
              <div className={styles.HeaderButtons}>
                <Link href="/authenticate/register">
                  <a className="inline-block text-white cursor-pointer border-2 border-white rounded-full px-12 py-2 font-semibold hover:bg-white hover:text-black duration-150">
                    Đăng ký ngay
                  </a>
                </Link>
              </div>
